...
from .utils import XmlDictConfig, normalize_dictionary_values, smart_str
...
class BaseHandler(object):
    ...
    def _get_params(self):
        ...
        params = OrderedDict(sorted(list(params.items()), key=order_keys))
    ...
    def _generate_hash(self):
        ...
        for key, val in self._get_params().items():
        ...
        self.hash = hashlib.md5(str_hash.encode('utf-8')).hexdigest()
